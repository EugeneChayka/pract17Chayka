...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    static final String TABLE = "Animal"; // название таблицы в бд
    // названия столбцов
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE Animal (" + COLUMN_ID
                + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_Animal
                + " TEXT, " + COLUMN_NAME + " TEXT, " + COLUMN_Size + " integer, "
                + COLUMN_Weight + " integer)");
        String ADD_COLUMN = "ALTER TABLE " + COLUMN_ID + " ADD COLUMN " + COLUMN_Size + " INTEGER;";

        ...
        {   animalList.clear();
            ...
            if (userCursor.moveToFirst()) {
                ...
                int WeightIndex=userCursor.getColumnIndex(DatabaseHelper.COLUMN_Weight);
                    do{
                        String Animal = userCursor.getString(AnimalIndex);
                        String Name = userCursor.getString(NameIndex);
                        String Size = String.valueOf(userCursor.getInt(SizeIndex));
                        String Weight = String.valueOf(userCursor.getInt(WeightIndex));

                        String animalDetails = "Animal: " + Animal + ",  Name: " + Name +
